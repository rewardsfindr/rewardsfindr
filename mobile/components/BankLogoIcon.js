// ─────────────────────────────────────────────
// BANK LOGO ICON
// Uses local PNG asset if available, else branded tile.
// Add more PNGs to assets/banks/ and register below.
// ─────────────────────────────────────────────
import React from 'react';
import { View, Text, Image, StyleSheet } from 'react-native';

// Register local PNG assets here as they are added
const LOCAL_LOGOS = {
  chase: require('../assets/banks/chase.png'),
  // amex: require('../assets/banks/amex.png'),
  // capital_one: require('../assets/banks/capital_one.png'),
  // citi: require('../assets/banks/citi.png'),
  // discover: require('../assets/banks/discover.png'),
  // wells_fargo: require('../assets/banks/wells_fargo.png'),
  // bofa: require('../assets/banks/bofa.png'),
};
